...
async function adminVerification() {
	// var admin_status = await fetch("http://localhost:8999/check_admin", {
...
async function searchQuestion() {
	...
	async function getQuestionsFromDb() {
		...
		try {
			...
			var search_res = await fetch("http://localhost:8999/search_questions/", {
...
async function editQuestionEvent(body) {
	...
	try {
		...
		var edit_question = await fetch("http://localhost:8999/post_question_to_edit_on_welcome_page", {
...
async function deleteQuestionEvent(body) {
	...
	var delete_question = await fetch(`http://localhost:8999/delete_question/${body.question_id}`, {
